...
def define_flags():
  flags.DEFINE_string("model_file", 'models\\mobilenet_v3_large_food_classifier.tflite',
                      "Path and file name to the TFLite model file.")
  flags.DEFINE_string("label_file", 'models\\main_classes.txt',
                      "Path to the label file.")
  flags.DEFINE_string("export_directory", 'models\\with_metadata',
...
_MODEL_INFO = {
    "mobilenet_v3_large_food_classifier.tflite":
        ModelSpecificInfo(
